...
description: "Welcome to Salesvoicesai.com documentation"
---

<img
  className="block dark:hidden"
  src="https://autocalls.ai/ogimage-en.jpg"
  alt="Salesvoicesai.com"
/>
...
<Steps>
  ...
  <Step title="Create a campaign">
    Define the campaign parameters, such as calling hours interval, days of the week, retry interval, etc.
  </Step>
